            ...
            <div class="card-body">
                        ...
                        <div class="col-xl-3">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="d-flex">
                                        <h5 class="card-title flex-grow-1 mb-0 text-black"><i class=" ri-cake-3-line align-middle me-1 text-black"></i> Order Details</h5>
                                ...
                                <div class="card-body">
                                        ...
                                        <span><i class="ri-user-3-line me-2 align-middle text-black fs-16"></i><?php echo $orderData['firstname'].' '.$orderData['lastname'] ?></span></br>
                                        <span><i class="ri-mail-line me-2 align-middle text-black fs-16"></i><?php echo $orderData['accounts_email']; ?></span></br>
                                        <span><i class="ri-phone-line me-2 align-middle text-black fs-16"></i><?php echo $orderData['delivery_contact']; ?></span></br>
                                        <span><i class="ri-calendar-event-line me-2 align-middle text-black fs-16"></i><?php echo "Order Date :  ".date('d/m/Y',strtotime($orderData['date_added'])); ?></span>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0 text-black"><i class="ri-map-pin-line align-middle me-1 text-black"></i> Delivery Details</h5>
                                </div>
                                <div class="card-body">
   ...
   $(document).ready(function() {
    $('.submit').click(function(event) {
       ...
       let orderStatus = $(this).data('orderstatus');
        ...
        $.ajax({
            url: '/External/updateOrderStatus',
            method: 'POST',
            data: $.param(formData),
