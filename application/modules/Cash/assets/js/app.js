...
(function () {
	...
	function setLanguage(lang) {
		if (document.getElementById("header-lang-img")) {
			if (lang == "en") {
				document.getElementById("header-lang-img").src = "/Supplier/assets/images/flags/us.svg";
			} else if (lang == "sp") {
				document.getElementById("header-lang-img").src = "/Supplier/assets/images/flags/spain.svg";
			} else if (lang == "gr") {
				document.getElementById("header-lang-img").src = "/Supplier/assets/images/flags/germany.svg";
			} else if (lang == "it") {
				document.getElementById("header-lang-img").src = "/Supplier/assets/images/flags/italy.svg";
			} else if (lang == "ru") {
				document.getElementById("header-lang-img").src = "/Supplier/assets/images/flags/russia.svg";
			} else if (lang == "ch") {
				document.getElementById("header-lang-img").src = "/Supplier/assets/images/flags/china.svg";
			} else if (lang == "fr") {
				document.getElementById("header-lang-img").src = "/Supplier/assets/images/flags/french.svg";
			}
	...
	function getLanguage() {
		...
		request.open("GET", "/Supplier/assets/lang/" + language + ".json");
	...
	function twoColumnMenuGenerate() {
		...
		if (defaultValues && (isTwoColumn == "twocolumn" || defaultValues["data-layout"] == "twocolumn")) {
			...
			ul.innerHTML = '<a href="#" class="logo"><img src="/Supplier/assets/images/logo-sm.png" alt="" height="22"></a>';
...
// 			document.querySelector(".hamburger-icon").classList.add("open");
	...
	function toggleHamburgerMenu() {
		...
		if (document.documentElement.getAttribute("data-layout") === "horizontal") {
			...
			document.querySelector(".hamburger-icon").classList.contains("open") ? document.querySelector(".hamburger-icon").classList.remove("open") : document.querySelector(".hamburger-icon").classList.add("open");
		}
	...
	function layoutSwitch(isLayoutAttributes) {
		switch (isLayoutAttributes) {
			case isLayoutAttributes:
				...
				// 			console.log('LT theme session: '+sessionStorage.getItem("data-layout-mode") );
						break;
					case "dark":
							getElementUsingTagname("data-layout-mode", "dark");
							document.documentElement.setAttribute("data-layout-mode", "dark");
							sessionStorage.setItem("data-layout-mode", "dark");
				// 			console.log('DK theme session: '+sessionStorage.getItem("data-layout-mode") );
						break;
					default:
					   // console.log('theme session: '+sessionStorage.getItem("data-layout-mode") );
