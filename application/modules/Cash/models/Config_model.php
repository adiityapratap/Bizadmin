...
class Config_model extends CI_Model{
    ...
    // Configuration of mail
     public function configure($data,$id=''){
		    ...
		    if($id){ 
		      ...
		      $builder->set($data);
              $builder->where('id', $id);
              $builder->update('CASH_ci_configuration'); 
            return true;
		    }else{
		    return $builder->insert('CASH_ci_configuration',$data);    
		    }
	...
	function configureAutomatedNotificationsubmit($data,$id=''){
		...
		public function deleteConfig($id){
         ...
         $this->tenantDb->delete('CASH_ci_configuration');   
          return true;
		}
	 
     
     public function getConfiguration($configureFor,$metaData='',$tableName='CASH_ci_configuration'){
	     $conditions = array(
