                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="card-header">
                                   ...
                                   <h4 class="mb-sm-0 text-black">Office Reset</h4>
    
                                    <div class="page-title-right">
                                        <div class="d-flex justify-content-sm-end">
                                         
                                            <div class="d-flex justify-content-sm-end">
                                              <a href="/Cash/officeBuildAdd" class="btn btn-primary"> <i class="ri-add-line align-bottom me-1"></i>Order Change</a>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <table class="table align-middle table-nowrap" id="floatListDatatable">
                                                    <thead class="table-light">
                                                     ...
                                                     <tbody class="list form-check-all">
                                                        <?php if(!empty($officeBuildList)) {  ?>
                                                        <?php foreach($officeBuildList as $cd){  if($cd['otherDetails']){ $rawDetails = unserialize($cd['otherDetails']); } ?>
                                                        <tr id="row_<?php echo  $cd['id']; ?>" >
                                                           <td class="manager_name"><?php echo $cd['id']; ?></td>
                                                            <td class="created_date"><?php echo date('d-m-Y',strtotime($cd['created_date'])); ?></td>
                                                             ...
                                                             <td class="manager_name"><?php echo $cd['orderStatus']; ?></td>
                                                             <td class="manager_name"><?php echo "$".$cd['amountInCashTotal']; ?></td>
                                                            <td>
                                                             <div class="d-flex gap-2">
                                                                   
                                                                    <div class="edit">
                                                                        <a  href="<?php echo base_url(); ?>Cash/officeBuildAction/<?php echo $cd['id']; ?>/view" class="btn btn-sm btn-secondary">View</a>
                                                                    </div>
                                                                    <!--<div class="edit">-->
                                                                    <!--    <a  href="<?php echo base_url(); ?>/officeBuildAction/<?php echo $cd['id']; ?>/edit" class="btn btn-sm btn-info">Edit</a>-->
                                                                    <!--</div>-->
                                                                    <!--<div class="remove">-->
