            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    ...
                    <div class="card-body">
                                                    ...
                                                    <div class="col-sm">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-12 col-lg-3 col-md-4 mb-3">
                                                                ...
                                                                <input type="text" <?php echo ((isset($staffdisabled) && $staffdisabled !='') || $disableAdminEdit !=''  ? 'readonly' : '');   ?> value="<?php echo (isset($items_detail['end_staff_name']) ? $items_detail['end_staff_name'] : '') ?>"  class="form-control" id="end_staff_name" name="end_staff_name"  placeholder="End Shift Staff name">
                                                           ...
                                                           <?php if($this->ion_auth->get_users_groups()->row()->name == 'Manager' || $this->ion_auth->is_admin()){ ?>
                                                            <div class="col-12 col-lg-3 col-md-4 mb-3">
                                                                ...
                                                                <input type="text" <?php echo ((isset($managerdisabled) && $managerdisabled !='')  ? 'readonly' : ''); ?> value="<?php echo (isset($items_detail['manager_name']) ? $items_detail['manager_name'] : '') ?>"  class="form-control" id="manager_name" name="manager_name"  placeholder="Manager name">
                                                            </div>
                                                        <?php } ?>
                                                             <div class="col-12 col-lg-3 col-md-4 mb-3">
                                                                ...
                                                                <input readonly value="<?php echo (isset($items_detail['end_time']) ? date('d-m-Y h:i A',strtotime($items_detail['end_time'])) : date('d-m-Y h:i A')) ?>" type="text" <?php echo (isset($disabled) ? $disabled : ''); ?> class="form-control" id="datetime" name="end_time"  placeholder="Date" required>
                                                            </div>
                           ...
                           <?php   if($this->ion_auth->get_users_groups()->row()->name == 'Staff' && $staffdisabled =='disabled'){  ?>
                           <?php } elseif($this->ion_auth->get_users_groups()->row()->name != 'Staff' && $managerdisabled =='disabled'){ ?>
                         ...
                         <i class="ri-send-plane-line label-icon align-middle fs-12 me-2"></i>Submit</button> 
                           <?php } ?>
                              <input type="hidden" id="roleNameOfLoggedInUser" value="<?php echo $this->ion_auth->get_users_groups()->row()->name; ?>">                             
                                                             ...
                                                             <table class="row-border table-condensed endShiftTable" cellspacing="0" width="100%">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    foreach(COINS as $row ){ ?>
                                                                        ...
                                                                        <tr class="menurow">
                                                                            ...
                                                                            <td class="menuinput-width">
                                                                                 <div class="form-icon">
                                                                                    <input type="number" <?php echo ((isset($staffdisabled) && $staffdisabled !='') || $disableAdminEdit !=''  ? 'disabled' : '');   ?> class="form-control"  value="<?php echo (isset($coins[$row['inputName']]) ? $coins[$row['inputName']] : '') ?>"  id="<?php echo $row['inputId1'] ?>" name="<?php echo $row['inputName'] ?>">
                                                                                </div>
                                                                            </td>
                                                                ...
                                                                <tbody>
                                                                    <tr class="menurow footer-labels">
                                                                     ...
                                                                     <tr class="menurow footer-labels">
                                                                         <td class="menuinput-width tableFooterTotals antiquewhite">
                                                                             <small>Count float of $600, record amounts above and place into register. Put leftover money to the side. </small>
                                                                            </td>
                                                                            <td class="menuinput-width tableFooterTotals antiquewhite">
                                                                           ...
                                                                           <tr class="menurow footer-labels">
                                                                          <td class="menuinput-width tableFooterTotals antiquewhite">
                                                                              <small>Count remaining money from the side and add petty cash receipt to total deposit</small>
                                                                            </td>
                                                                            <td class="menuinput-width tableFooterTotals antiquewhite">
