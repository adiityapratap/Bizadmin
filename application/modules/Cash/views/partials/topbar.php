        ...
        <div class="navbar-header">
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    ...
                    <a href="/Cash/<?php echo $this->session->userdata('system_id'); ?>" class="logo logo-dark">
                    ...
                    <a href="/Cash/<?php echo $this->session->userdata('system_id'); ?>" class="logo logo-light">
                    ...
                    <div class="dropdown-menu dropdown-menu-end bg-primary">
                        ...
                        <!--        class="align-middle">Profile</span></a>-->
                         ...
                         <?php if ($this->session->userdata('is_admin')){ ?>
                          ...
                          <a class="dropdown-item" target="_blank" href="<?= base_url('Cash/configureFloats') ?>"><i
