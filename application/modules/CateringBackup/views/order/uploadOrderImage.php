...
<div class="row">
					...
					<div class="col-12">
						<div class="card card-shadow mb-4">
							...
							<div class="card-body">
								<form action="<?php echo base_url();?>index.php/order/saveUploadedFile" enctype="multipart/form-data" method="POST" id="order_comment_form">
                					...
                					<div class="parentWrap">
                    					<div class="row mt-2 rowWrap">
                    						...
                    						<div class="col-4">
                    						    <button type="button" class="add_btn btn btn-info btn-sm px-3 me-2">Add Row</button>
                    						</div>
                    					</div>
                    					<div class="row mt-2">
                    						<div class='col-12'>
                    							<button type="submit" class="btn btn-success btn-sm">Save Attachments</button>
                    						</div>
                    					</div>
                					</div>
                				</form>
...
<script>
    ...
    var parentWrap = $('.parentWrap');
       ...
       $('<button type="button" class="del_btn btn btn-danger btn-sm">Delete Row</button>').insertAfter(thisRowAddbtn);
        } 
