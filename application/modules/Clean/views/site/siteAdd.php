                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <?php  if($form_type == 'add'){ ?>    
                                        <form action="/Clean/Site/add" method="POST">
                                             <?php }else if($form_type == 'edit'){ ?>
                                            <form action="/Clean/Site/edit/<?php echo (isset($site_detail[0]['id']) ? $site_detail[0]['id'] : ''); ?>" method="POST">     
                                              <?php } ?>
                                        <div id="customerList">
                                            <div class="row g-4 mb-3">
                                                ...
                                                <div class="col-sm">
                                                    <div class="d-flex justify-content-sm-end gap-2">
                                                        ...
                                                        <?php } ?>
                        <a href="/Clean/site" class="btn bg-orange waves-effect btn-label waves-light"><i class="ri-reply-fill label-icon align-middle fs-16 me-2"></i><span>Back</span></a>
                                                    </div>
                                                </div>
                                            </div>
