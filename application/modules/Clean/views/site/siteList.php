                                  ...
                                  <div class="card-header">
                                    ...
                                    <div class="page-title-right">
                                        <div class="d-flex justify-content-sm-end">
                                            ...
                                            <div class="d-flex justify-content-sm-end">
                                                <a href="<?php echo  base_url('Clean/site/add') ?>" class="btn btn-primary"> <i class="ri-add-line fs-14 align-bottom me-1"></i>Add Site</a>
                                                     ...
                                                     <tbody class="list form-check-all">
                                                       ...
                                                       <ul class="list-inline hstack gap-2 mb-0">
                                                                ...
                                                                <li class="list-inline-item edit" data-bs-toggle="tooltip" data-bs-trigger="hover"
                                                                    ...
                                                                    <a href="<?php echo base_url('Clean/site/edit/'.$site['id']); ?>"  class="text-primary d-inline-block edit-item-btn">
