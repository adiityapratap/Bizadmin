<div class="container" style="margin-top: 130px !important;">
   <div class="row">
     ...
     <form class="row g-3 needs-validation" novalidate action="<?php echo base_url("Clean/task/edit/".$taskData->id) ?>" method="post">  
     <input type="hidden" name="id" value="<?php echo $taskData->id; ?>">
            <?php }else { ?>
     <form class="row g-3 needs-validation" novalidate action="<?php echo base_url("Clean/task/add") ?>" method="post">        
            <?php } ?>            
            <div class="card-header align-items-center d-flex">
                         <h4 class="card-title mb-0 flex-grow-1 text-black">Create Cleaning Task</h4>
                             ...
                             <div class="col-4 col-md-4 col-sm-6">
                                           <label for="role_id" class="form-label fw-semibold">Role *</label>
                                            <select class="js-example-basic-multiple" name="role_id[]"  multiple>
                                             ...
                                             <?php if (!empty($selectedRoleId) && in_array($role['id'], (array)$selectedRoleId)) { ?>
        ...
        <small>Add the time by which the task should be recorded. Multiple times can be added if required. </small> 
                 </div>
