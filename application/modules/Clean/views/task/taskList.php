                            ...
                            <div class="card py-3" id="orderList">
                                <div class="card-header  border-0 ">
                                    <div class="d-flex align-items-center gap-2">
                                        <h5 class="card-title mb-0 flex-grow-1 text-black">Cleaning Tasks</h5>
                                       <a type="button" class="btn btn-primary btn-sm fs-14" 
                                                id="create-btn" href="<?php echo base_url('Clean/task') ?>"><i
                                                    class="ri-add-line align-bottom "></i> Create Cleaning Task 
                                                </a>
                                                ...
                                                <tbody class="list form-check-all" id="sortable">
                                                    ...
                                                    <tr id="<?php echo 'row_'.$task->id;  ?>">
                                                       ...
                                                       <div class="form-check form-switch form-switch-custom form-switch-success">
                                                        <input class="form-check-input checklisttoggle-demo" type="checkbox" role="switch" data-tablename="CLEAN_tasks" data-id="<?php echo  $task->id; ?>" <?php echo ($task->status ? 'checked' : '');  ?>>
                                                       </div>
                                                       </td>
                                                        ...
                                                        <td>
                                                            <ul class="list-inline hstack gap-2 mb-0">
                                                                ...
                                                                <li class="list-inline-item edit" data-bs-toggle="tooltip" data-bs-trigger="hover"
                                                                    ...
                                                                    <a href="<?php echo base_url('Clean/Task/edit/'.$task->id) ?>"  class="text-primary d-inline-block edit-item-btn">
...
function deleteMultipleCheckl(){
   ...
   $('.checkbox-item:checked').each(function() {
      ...
      if (selectedValues.length > 0) {
            $.ajax({
                url: '/Clean/Task/deleteMultiple',
                type: 'POST',
                data: { 
                    table_name: 'CLEAN_tasks', 
 ...
 $(document).on("click", "#delete-record" , function() {
     let id = $(this).val();
       $.ajax({
         ...
         data:'id='+id+'&table_name=CLEAN_tasks',
...
$(function() {
    ...
    $("#sortable").sortable({
        ...
        update: function(event, ui) {
            ...
            $.ajax({
                url: "/Clean/Task/updateSortOrder",
                type: "POST",
