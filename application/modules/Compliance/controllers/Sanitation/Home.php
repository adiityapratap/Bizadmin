...
class Home extends MY_Controller {
    ...
    public function index($system_id = '') {
        ...
        $data['site_detail'] = $this->common_model->fetchRecordsDynamically('Compliance_Sanitationsites', [], ['status' => 1]);
        $data['prep_detail'] = $this->prep_model->fetchAllPrepArea('Compliance_SanitationPrepArea','Compliance_Sanitationsites');
        $data['products'] = $this->common_model->fetchRecordsDynamically('Compliance_Sanitationproducts', [], ['status' => 1]);
    // echo "<pre>";
    ...
    public function historyData($encodedDateRange = '', $prep_id = '') {
        ...
        if (count($dateParts) == 2) {
            ...
            $data['site_detail'] = $this->common_model->fetchRecordsDynamically('Compliance_Sanitationsites', [], []);
