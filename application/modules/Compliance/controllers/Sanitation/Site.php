...
class Site extends MY_Controller
{
    ...
    {   
   	...
   	public function index(){
            ...
            $this->load->view('Sanitation/siteList',$data);
	...
	public function add(){
			if(isset($this->POST['site_name'])){
					$site_data = array(
					 ...
					 $this->common_model->commonRecordCreate('Compliance_Sanitationsites',$site_data);
					
				redirect('Compliance/Sanitation/Site', 'refresh');
			}else{
			 $data['form_type'] ='add';   
			$this->load->view('general/header');
            $this->load->view('Sanitation/siteAdd',$data);
            $this->load->view('general/footer');
...
// 		ini_set('display_errors', 1);
			...
			if(isset($this->POST['site_name'])){
				...
				$this->common_model->commonRecordUpdate('Compliance_Sanitationsites','id',$site_id, $site_data);
				redirect('Compliance/Sanitation/Site', 'refresh');
			}else{
	...
	function change_status(){
		...
		$this->common_model->commonRecordUpdate('Compliance_Sanitationsites','id',$this->POST['id'], $site_data);
		echo "success";
	}
