                        ...
                        <div class="col-12 tempDiv">
                            <div class="card">
                              <div class="card-header align-items-center d-flex">
                               <h4 class="card-title mb-0 flex-grow-1 text-faded">Incoming / allocated stock checklist History</h4>   
                                  
                                   </div>  
                                
                                 <div class="card-body">
                                     <form action="<?php echo base_url('/Compliance/Goods/home/historyData') ?>" method="post">
