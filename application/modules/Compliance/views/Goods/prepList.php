                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                  <div class="card-header">
                                    ...
                                    <h4 class="mb-sm-0 text-black ">Goods Management Area</h4>
        ...
        <?php foreach ($prep_detail as $prep) { ?>
            <tr id="row_<?php echo $prep['id']; ?>">
                ...
                <td class="customer_name">
                    <?php echo $prep['prep_name']; ?>
                </td>

                <td class="customer_name">
                    <?php echo isset($prep['site_name']) ? $prep['site_name'] : 'N/A'; ?>
                </td>

                <td>
                    <div class="form-check form-switch form-switch-custom form-switch-success">
                        <input
                            class="form-check-input toggle-demo"
                            type="checkbox"
                            role="switch"
                            id="<?php echo $prep['id']; ?>"
                            <?php echo (!empty($prep['status']) && $prep['status'] == 1) ? 'checked' : ''; ?>
                        >
                    </div>
                </td>
                        ...
                        <li class="list-inline-item edit" title="Edit">
                            <a
                                onclick="showEditModal(
                                    '<?php echo addslashes($prep['prep_name']); ?>',
                                    '<?php echo $prep['site_id']; ?>',
                                    '<?php echo $prep['id']; ?>'
                                )"
    ...
    <?php } ?>
     ...
     $(document).on("click", ".remove-item-btn" , function() {
                var id = $(this).attr('data-rel-id');
                    Swal.fire({
                      ...
                      if (e.value) {
                        $.ajax({
                            type: "POST",
                             url: "/Compliance/Goods/Prep/delete",
                            data:'id='+id,
      ...
      $('#prepListDatatable').DataTable({
        ...
        function updatePrep(){
            ...
            $.ajax({
                 type: "POST",
                 url: "/Compliance/Goods/Prep/edit",
     ...
     if($(this).prop('checked')){
      ...
      enctype: 'multipart/form-data',
        ...
        url: "/Compliance/Goods/Prep/change_status",
