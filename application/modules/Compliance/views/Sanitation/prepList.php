 <div class="main-content">
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                  <div class="card-header">
                                    ...
                                    <h4 class="mb-sm-0 text-black ">Sanitation Management Area</h4>
     ...
     $(document).on("click", ".remove-item-btn" , function() {
                var id = $(this).attr('data-rel-id');
                    Swal.fire({
                      ...
                      if (e.value) {
                        $.ajax({
                            type: "POST",
                             url: "/Compliance/Sanitation/Prep/delete",
                            data:'id='+id,
      ...
      $('#prepListDatatable').DataTable({
        ...
        function addSite(){
            ...
            $.ajax({
                 type: "POST",
                 url: "/Compliance/Sanitation/Prep/add",
        ...
        function updatePrep(){
            ...
            $.ajax({
                 type: "POST",
                 url: "/Compliance/Sanitation/Prep/edit",
     ...
     if($(this).prop('checked')){
      ...
      enctype: 'multipart/form-data',
        ...
        url: "/Compliance/Sanitation/Prep/change_status",
