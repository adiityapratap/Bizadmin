<?php if($form_type == 'view'){ $disabled = 'disabled'; }else{ $disabled = ''; } ?>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <?php  if($form_type == 'add'){ ?>    
                                        <form action="/Compliance/Sanitation/Site/add" method="POST">
                                             <?php }else if($form_type == 'edit'){ ?>
                                            <form action="/Compliance/Sanitation/Site/edit/<?php echo (isset($site_detail[0]['id']) ? $site_detail[0]['id'] : ''); ?>" method="POST">     
                                              <?php } ?>
                                        <div id="customerList">
                                            <div class="row g-4 mb-3">
                                                ...
                                                <div class="col-sm">
                                                    <div class="d-flex justify-content-sm-end gap-2">
                                                        ...
                                                        <?php } ?>
                        <a href="/Compliance/site" class="btn bg-orange waves-effect btn-label waves-light"><i class="ri-reply-fill label-icon align-middle fs-16 me-2"></i><span>Back</span></a>
                                                    </div>
                                                </div>
                                            </div>
        ...
        <small>Add the predetermined action items to be available for Staff</small> 
                 </div>     
                                <div class="col-md-5">
        ...
        <small>Add the predetermined action items to be available for Manager</small> 
                 </div>
                 </div>
