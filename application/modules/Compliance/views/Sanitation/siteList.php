 <div class="main-content">
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                  <div class="card-header">
                                    ...
                                    <h4 class="mb-sm-0 text-black">Sanitation Management Site</h4>
    
                                    <div class="page-title-right">
                                        <div class="d-flex justify-content-sm-end">
                                         
                                            <div class="d-flex justify-content-sm-end">
                                                <a href="<?php echo  base_url('Compliance/Sanitation/site/add') ?>" class="btn btn-primary"> <i class="ri-add-line fs-14 align-bottom me-1"></i>Add Site</a>
                                                     ...
                                                     <tbody class="list form-check-all">
                                                       ...
                                                       <ul class="list-inline hstack gap-2 mb-0">
                                                                ...
                                                                <li class="list-inline-item edit" data-bs-toggle="tooltip" data-bs-trigger="hover"
                                                                    ...
                                                                    <a href="<?php echo base_url('Compliance/Sanitation/site/edit/'.$site['id']); ?>"  class="text-primary d-inline-block edit-item-btn">
      ...
      $('#siteListDatatable').DataTable({
        ...
        function addSite(){
            ...
            $.ajax({
                 type: "POST",
                 url: "Site/add",
                 url: "/Compliance/Sanitation/Site/add",
        ...
        function updatesite(){
            ...
            $.ajax({
                 type: "POST",
                 url: "/Compliance/Sanitation/Site/updatesite",
     ...
     if($(this).prop('checked')){
      ...
      enctype: 'multipart/form-data',
        url: "/Compliance/Sanitation/Site/change_status",
