 <div class="main-content">
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                  <div class="card-header">
                                    ...
                                    <h4 class="mb-sm-0 text-black ">Waste Management Area</h4>
                ...
                var id = $(this).attr('data-rel-id');
                    Swal.fire({
                      ...
                      if (e.value) {
                        $.ajax({
                            type: "POST",
                             url: "/Compliance/Waste/Prep/delete",
                            data:'id='+id,
     ...
     if($(this).prop('checked')){
      ...
      enctype: 'multipart/form-data',
        ...
        url: "/Compliance/Waste/Prep/change_status",
