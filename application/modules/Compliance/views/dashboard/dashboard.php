<div class="container-fluid mb-5" style="margin-top: 130px !important;">
   <div class="row">
                        ...
                        <a class="btn btn-danger btn-sm mb-2 " href="/Compliance/<?php echo $this->session->userdata('system_id'); ?>">Cake Display</a> 
                      
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    <h4 class="card-title mb-0 flex-grow-1 text-faded">💻  Compliances  🗓 <?php echo date('d-m-Y') ?></h4>
