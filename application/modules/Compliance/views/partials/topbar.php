        ...
        <div class="navbar-header">
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    ...
                    <a href="/Compliance/<?php echo $this->session->userdata('system_id'); ?>" class="logo logo-dark">
                    ...
                    <a href="/Compliance/<?php echo $this->session->userdata('system_id'); ?>" class="logo logo-light">
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-end bg-primary">
                        ...
                        <?php if ($this->session->userdata('is_admin')){ ?>
                          ...
                          <a class="dropdown-item" target="_blank" href="<?= base_url('Compliance/settings') ?>"><i
