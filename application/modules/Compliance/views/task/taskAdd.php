<div class="container" style="margin-top: 130px !important;">
   <div class="row">
     ...
     <form class="row g-3 needs-validation" novalidate action="<?php echo base_url("Compliance/task/edit/".$taskData->id) ?>" method="post">  
     <input type="hidden" name="id" value="<?php echo $taskData->id; ?>">
            <?php }else { ?>
     <form class="row g-3 needs-validation" novalidate action="<?php echo base_url("Compliance/task/add") ?>" method="post">        
            <?php } ?>            
                             ...
                             <div class="col-4 col-md-4 col-sm-6">
                                           <label for="role_id" class="form-label fw-semibold">Role *</label>
                                            <select class="js-example-basic-multiple" name="role_id[]"  multiple>
                                             ...
                                             <?php if(in_array($role['id'],$selectedRoleId)){ ?>
