                            ...
                            <div class="card py-3" id="orderList">
                                <div class="card-header  border-0 ">
                                    <div class="d-flex align-items-center gap-2">
                                        <h5 class="card-title mb-0 flex-grow-1 text-black">Compliances</h5>
                                       <a type="button" class="btn btn-primary btn-sm fs-14" 
                                                id="create-btn" href="<?php echo base_url('Compliance/task') ?>"><i
                                                    class="ri-add-line align-bottom "></i> Create Compliance 
                                                </a>
                                            ...
                                            <table class="table table-nowrap align-middle" id="activeEquip">
                                                ...
                                                <tbody class="list form-check-all" id="sortable">
                                                    ...
                                                    <tr id="<?php echo 'row_'.$task->id;  ?>">
                                                        ...
                                                        <td class="descr text-wrap handle"><?php echo (isset($task->prep_name) ? $task->prep_name : '');  ?></td>
                                                        <td class="descr text-wrap handle"><?php echo (isset($task->site_name) ? $task->site_name : '');  ?></td>
                                                       ...
                                                       <div class="form-check form-switch form-switch-custom form-switch-success">
                                                        <input class="form-check-input checklisttoggle-demo" type="checkbox" role="switch" data-tablename="Compliance_tasks" data-id="<?php echo  $task->id; ?>" <?php echo ($task->status ? 'checked' : '');  ?>>
                                                       </div>
                                                       </td>
                                                        ...
                                                        <td>
                                                            <ul class="list-inline hstack gap-2 mb-0">
                                                                ...
                                                                <li class="list-inline-item edit" data-bs-toggle="tooltip" data-bs-trigger="hover"
                                                                    ...
                                                                    <a href="<?php echo base_url('Compliance/Task/edit/'.$task->id) ?>"  class="text-primary d-inline-block edit-item-btn">
                                                                ...
                                                                <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover"
                                                                    ...
                                                                    <a class="text-danger d-inline-block remove-item-btn" data-bs-toggle="modal"
                                                                        onclick="deleteThisChecklist(this,<?php echo  $task->id; ?>)">
...
function deleteMultipleCheckl(){
   ...
   $('.checkbox-item:checked').each(function() {
      ...
      if (selectedValues.length > 0) {
            $.ajax({
                url: '/Compliance/Task/deleteMultiple',
                type: 'POST',
                data: { 
 ...
 $(document).on("click", "#delete-record" , function() {
     let id = $(this).val();
       $.ajax({
         ...
         data:'id='+id+'&table_name=Compliance_tasks',
...
$(function() {
    ...
    $("#sortable").sortable({
        ...
        update: function(event, ui) {
            ...
            $.ajax({
                url: "/Compliance/Task/updateSortOrder",
                type: "POST",
