        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
              <h5 class="card-title mb-0 text-black">Resignation Letter</h5>
              <a class="btn btn-primary" type="button" href="<?php echo base_url('/HR/resignationL/AddResignationL') ?>"><i class="ri-user-add-line"></i> Resign</a>
            </div>
            <div class="card-body">
             <table id="reportList" class="table dt-responsive nowrap table-striped align-middle" style="width:100%">
                ...
                <tbody>
                  ...
                  <tr data-delete-id="<?php echo $reportList['Resignation_Letter_id']; ?>">
                    <td><?php echo $reportList['name']; ?></td>
                    <td><?php echo date('d-m-Y',strtotime($reportList['resign_date'])); ?></td>
                    <td>
                     <ul class="list-inline hstack gap-2 mb-0">
                         <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="View/Edit">
                        <a class="text-success d-inline-block" href="<?php echo '/HR/resignationL/AddResignationL/'.$reportList['Resignation_Letter_id'] ?>">
                            <i class="ri-pencil-fill fs-16"></i></a></li>
                          <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Delete">
                            <a class="text-danger d-inline-block remove-item-btn" onclick="deleteRecord(this,<?php echo $reportList['Resignation_Letter_id']; ?>)">
...
$('#delete-record').click(function(){
      ...
      let deleteId =  $(".deletedRecordId").val();
       $.ajax({
        type: "POST",
        "url" : "/HR/resignationL/delete",
        data:'Resignation_Letter_id='+deleteId,
