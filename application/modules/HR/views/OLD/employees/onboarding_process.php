  			...
  			<div class="col-lg-12">
                           	    ...
                           	    <input type="hidden" name="emp_id" value="<?php echo $row->emp_id; ?>">
                					<div class="row">
                					  ...
                					  <div class="col-md-12">
                					      ...
                					      ?>
                					     I hereby authorize <?php echo $location; ?> to initiate automatic deposits for my fortnightly wages to my bank account(s) as detailed above and also authorise for adjustments to be deducted from my wage in the event that a payment is made in error. 
                ...
                This agreement will remain in effect until I provide written notice of cancellation from me or my financial institution, or until update the new banking details.
                          ...
                          <div class="panel-body">
            				        ...
            				        <!--button-->
                							<input type="button" rel="privacyPolicy" name="contact_submit" id="save_continue_annuation" class="btn btn-success btn-ph" value="SAVE AND CONTINUE">
                						</form>
                    			</div>
                            </div>
...
// 	emergency form submit
	...
	$('#save_continue_tax').click(function(e){
	    console.log($(".check_tfn_type ").val());
