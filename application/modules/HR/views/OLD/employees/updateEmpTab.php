        ...
        <div class="row"> 
            <div class="col-lg-12">
                <div class="page-content-inner">
                    ...
                    <form class="form-horizontal" id="ad_form" role="form" method="post" action="<?php echo base_url(); ?>index.php/admin/submit_update_employee" enctype="multipart/form-data">
                        <?php if(isset($row->emp_id)){ ?>	
                        ...
                        <div class="card" id="userList">
                            <div class="card-header border-bottom-dashed">
                             ...
                             <div class="card-body">
                                <ul class="nav nav-pills arrow-navtabs nav-success bg-light mb-3 cutomEmpNav" role="tablist">
                                ...
                                <div class="tab-content text-muted">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="form-icon right">
                                                            <input type="password" class="form-control" id="pin" name="pin" value="<?php echo $row->pin; ?>" placeholder="****" >
                                                            <i class="ri-eye-fill pointerCursor"  title="View PIN" onclick="view_pin(<?php echo $row->pin; ?>)"></i>
                                                        </div> 
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" data-provider="flatpickr" data-date-format="d M, Y"  data-deafult-date="<?php if($row->dob != ''){ echo date('d M, Y',strtotime($row->dob)); } ?>" name="dob" autocomplete="off" >
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="mb-3">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="date" class="form-control datetime"  value="<?php if($row->effective_start_date != '00-00-0000'){ echo $row->effective_start_date; }else{ echo ""; } ?>" name="effective_start_date" data-provider="flatpickr" data-date-format="d M, Y"  data-deafult-date="<?php echo date('d M, Y',strtotime($row->dob)); ?>" autocomplete="off" >
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12">
                                                            <div class="mb-3">
                                    ...
                                    <div class="tab-pane" id="policeDeductions" role="tabpanel">
                                        ...
                                        <p class="mb-0">
                                             <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="businessname" class="control-label text-dark">Upload Certificate</label>
                                    ...
                                    <div class="tab-pane" id="requiredFile" role="tabpanel">
                                        <h6 class="text-dark mb-3">Additional Docs</h6>
                                        <p class="mb-0">
                                            <div class="row mb-3 docRow">
                                                <div class="form-group col-md-5 col-sm-12">
                                                    <label for="businessname" class="control-label text-dark">Document Name</label>
                                                    <input type="text" class="form-control" name="required_docs_name[]">
                                                 
                                                </div>
                                                <div class="form-group col-md-5 col-sm-4">
                                                    <label for="businessname" class="control-label text-dark">Upload</label>
                                                    <input type="file" class="form-control" name="required_docs[]">
                                                 
                                                </div>
                                                <div class="form-group col-md-2 col-sm-2">
                                                    <p class="pointerCursor mt-2 mb-0 fw-medium docRowBtns"><button type="button" class="btn btn-success addDoc mx-1">+</button></p>
                                                </div>
                                            </div>
                                        </p>
                                    </div>
...
<script>
    ...
    $(document).on( 'click', '.addDoc', function () {
        ...
        var thisRow = $( this ).closest( '.docRow' );
        
        $( thisRow ).clone().insertAfter( thisRow ).find('.form-control').val( '' );
        
        var thisRowAddbtn = $( thisRow ).next('.docRow').find( '.docRowBtns' );
        if (!$(thisRow).has(".delDoc").length) {
            $( thisRowAddbtn ).append('<button type="button" class="btn btn-danger delDoc mx-1">-</button>');
        }
    });
