<div class="main-content">
           ...
           <div class="tab-content text-black">
            <div class="tab-pane fade show active" id="personalDetails" role="tabpanel">
                      <form  role="form" id="personalDetailsForm" method="post" class="mt-4" enctype="multipart/form-data">
                           <input type="hidden" name="emp_id" class="contracterId" value="<?php echo $contractor['emp_id']; ?>">
                	   ...
                	   <h4 class="text-black">Personal Details</h4>
                		...
                		<div class="col-lg-3 col-md-6">
                			...
                			<input type="text" id="first_name" class="form-control" name="first_name" value="<?php echo $contractor['first_name'] ?>"   autocomplete="off" >
                			<span class="fieldError" id="first_name_error"></span>
                		</div>
                		<div class="col-lg-3 col-md-6">
                		<label for="last_name" class=" control-label">Last Name:<span>*</span></label>
                		<input type="text" class="form-control" id="last_name" name="last_name"  value="<?php echo $contractor['last_name'] ?>"  autocomplete="off" >
                		<span class="fieldError" id="last_name_error"></span>
                		</div>
                	     <div class="col-lg-3 col-md-6">
                    	<label for="email" class="form-label">Email Address:<span>*</span></label>
                    	<input type="text"  class="form-control" id="email" name="email" value="<?php echo $contractor['email'] ?>"  autocomplete="off">
                    	<span class="fieldError" id="email_error"></span>
                    	</div>
                    	 <div class="col-lg-3 col-md-6">
                    	<label for="phone" class="form-label">Contact Number:<span>*</span></label>
                    	<input type="text" class="form-control" id="phone" name="phone" onkeypress='validate(event)' value="<?php echo $contractor['phone'] ?>"  autocomplete="off">
                    	<span class="fieldError" id="phone_error"></span>
                    	</div>
                    	
                  <!--  	<div class="col-lg-3 col-md-6">-->
                		<!--<label for="role" class=" control-label">Role:</label>-->
                		<!--<input type="text" class="form-control" id="role" name="role"  value="<?php echo $contractor['role'] ?>"  autocomplete="off" >-->
                		<!--</div>-->
                        ...
                        <div class="col-lg-3 col-md-6">
                         ...
                         <?php foreach($locations as $location){ $trimmedLocationIds = array_map('trim', $locationIdsArray);?> 
                         <?php if(isset($trimmedLocationIds) && in_array($location['location_id'],$trimmedLocationIds)) { ?> 
    ...
    <tr class="positionMainRow">
        <td class="gap-2 d-flex">
            ...
            <div class="col-lg-2 col-md-2">
                ...
                <div class="form-icon">
                    <input type="number" id="rate" class="form-control form-control-icon" name="rate[]" value="<?php echo number_format($employeePR['rate'], 2); ?>" autocomplete="off">
            ...
            <div class="col-lg-2 col-md-2">
                ...
                <div class="form-icon">
                    <input type="number" id="Saturday_rate" class="form-control form-control-icon" name="Saturday_rate[]" value="<?php echo number_format($employeePR['Saturday_rate'], 2); ?>" autocomplete="off">
                    <i class="bx bx-dollar"></i>
                </div>
            </div>
            <div class="col-lg-2 col-md-2">
                ...
                <div class="form-icon">
                    <input type="number" id="Sunday_rate" class="form-control form-control-icon" name="Sunday_rate[]" value="<?php echo number_format($employeePR['Sunday_rate'], 2); ?>" autocomplete="off">
                    <i class="bx bx-dollar"></i>
                </div>
            </div>
            <div class="col-lg-2 col-md-2">
                ...
                <div class="form-icon">
                    <input type="number" id="holiday_rate" class="form-control form-control-icon" name="holiday_rate[]" value="<?php echo number_format($employeePR['holiday_rate'], 2); ?>" autocomplete="off">
                    <i class="bx bx-dollar"></i>
                </div>
            </div>
                     ...
                     <input type="hidden" name="emp_id" class="contracterId" value="<?php echo $contractor['emp_id']; ?>">       	     
                                       <div class="row gy-4">      	    
                    					 <div class="col-lg-3 col-md-6">
                    						...
                    						<input type="text" id="nextkin_name_two" class="form-control required"  name="nextkin_name_two" value="<?php echo $contractor['nextkin_name_two'] ?>"  autocomplete="off">
                    					...
                    					<div class="col-lg-3 col-md-6">
                    						...
                    						<input type="text" class="form-control required"  id="nextkin_relationship_two"  name="nextkin_relationship_two" value="<?php echo $contractor['nextkin_relationship_two'] ?>"  autocomplete="off" >
                    							<span class="fieldError" id="nextkin_relationship_two_error"></span>
                    						</div>
                    					<div class="col-lg-3 col-md-6">
                    						<label for="businessname" class="form-label">Email Address:</label>
                    						<input type="text" class="form-control " name="nextkin_email_two"  value="<?php echo $contractor['nextkin_email_two'] ?>"  autocomplete="off" >
                    						
                    						</div>
                    							     
                    					<div class="col-lg-3 col-md-6">
                    						<label for="Phone No"  class="control-label ">Contact No:<span>*</span></label>
                    						<input type="text" id="nextkin_phone_no" class="form-control required"  name="nextkin_phone_no" value="<?php echo $contractor['nextkin_phone_no'] ?>"  autocomplete="off" >
    ...
    <input type="text" class="form-control" id="emergency_address" name="emergency_address" value="<?php echo $contractor['emergency_address'] ?>" placeholder="Start typing your address…" autocomplete="off">
                      ...
                      <form  role="form" id="companyDetailsForm" method="post" class="mt-4" enctype="multipart/form-data">
                	   ...
                	   <h4 class="text-black">Company Details</h4>
                		...
                		<div class="col-lg-3 col-md-6">
                			...
                			<input type="text" id="company_name" class="form-control" name="company_name"  value="<?php echo $contractor['company_name'] ?>"  autocomplete="off" >
                		</div>
                		
                	     <div class="col-lg-3 col-md-6">
                    	  <label for="company_contactName" class="form-label">Company Contact Name:<span>*</span></label>
                    	  <input type="text"  class="form-control" id="company_contactName" name="company_contactName" value="<?php echo $contractor['company_contactName'] ?>">
                    	   </div>
                    	 <div class="col-lg-3 col-md-6">
                    	  <label for="company_contactEmail" class="form-label">Email Address:<span>*</span></label>
                    	  <input type="text"  class="form-control" id="company_contactEmail" name="company_contactEmail" value="<?php echo $contractor['company_contactEmail'] ?>">
                    	   </div>  
                    	 <div class="col-lg-3 col-md-6">
                    	  <label for="company_contactNumber" class="form-label">Contact Number:<span>*</span></label>
                    	  <input type="text" class="form-control" id="company_contactNumber" name="company_contactNumber" onkeypress='validate(event)' value="<?php echo $contractor['company_contactNumber'] ?>"  autocomplete="off">
                    	  </div> 
                    	  <div class="col-lg-3 col-md-6">
                		 <label for="company_descr" class=" control-label">Company Description :<span>*</span></label>
                		<textarea class="form-control" id="company_descr" name="company_descr" rows="3"><?php echo $contractor['company_descr'] ?></textarea> 
                		  </div>
                    	</div> 
            ...
            <tbody>
                <?php if(isset($contractorDocs) && !empty($contractorDocs)) {  ?>
                <?php foreach($contractorDocs as $contractorDoc) { ?>
                <tr>
                 <td>
                <input type="text" name="file_name[]" class="form-control" value="<?php echo (isset($contractorDoc['document_name']) ? $contractorDoc['document_name'] : ''); ?>" required />
                </td>
                    <td class="gap-2 d-flex">
                    <input type="file" name="userfile[]" class="form-control" multiple/>
                     <input type="hidden" name="doc_ids[]" value="<?php echo (isset($contractorDoc['id']) ? $contractorDoc['id'] : ''); ?>"/>
                    </td>
                    <td>
                    <a href="<?php echo base_url('/uploaded_files/'.$this->tenantIdentifier.'/HR/OtherFiles/'.$contractorDoc['UploadedNewName']) ?>" class="btn btn-sm btn-success" target="_blank">View</a>    
       ...
       <div class="progress bg-success-subtle" id="progress" style="display: none;">
       <div class="progress-bar progress-bar-striped bg-success" role="progressbar" id="progress_bar" style="width: 0%;" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
       </div>    
