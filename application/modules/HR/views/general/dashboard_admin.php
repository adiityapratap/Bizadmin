                                ...
                                <div class="row row-cols-xxl-4 row-cols-md-4 row-cols-1 g-0">
                                    ...
                                    <div class="col">
                                        <div class="mt-3 mt-md-0 py-4 px-3">
                                            <h5 class="text-black text-uppercase fs-13">Late SignIn <i class="ri-arrow-up-circle-line text-success fs-18 float-end align-middle"></i></h5>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <i class="mdi mdi-login display-6 text-black"></i>
                                                </div>
                                                <div class="flex-grow-1 ms-3">
                                                    <h2 class="mb-0 text-black"><span class="counter-value" data-target="5">0</span></h2>
                                                </div>
                                            </div>
                                        </div>
                                    </div><!-- end col -->
                                    <div class="col">
                                        <div class="mt-3 mt-md-0 py-4 px-3">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1 ms-3">
                                                    <h2 class="mb-0 text-black"><span class="counter-value" data-target="2">0</span></h2>
                                                </div>
                                            </div>
                                        </div>
                                    </div><!-- end col -->
                                    <div class="col">
                                        <div class="mt-3 mt-lg-0 py-4 px-3">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1 ms-3">
                                                    <h2 class="mb-0 text-black"><span class="counter-value" data-target="4">0</span></h2>
                                                </div>
                                            </div>
                                        </div>
                                    </div><!-- end col -->
                                    <div class="col">
                                        <div class="mt-3 mt-lg-0 py-4 px-3">
                                            <h5 class="text-black text-uppercase fs-13">Total Employees <i class="ri-arrow-up-circle-line text-success fs-18 float-end align-middle"></i></h5>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <i class="ri-user-line display-6 text-black"></i>
                                                </div>
                                                <div class="flex-grow-1 ms-3">
                                                    <h2 class="mb-0 text-black"><span class="counter-value" data-target="20">0</span></h2>
                                                </div>
                                            </div>
                                        </div>
                                    </div><!-- end col -->
                                            ...
                                            <div class="col-auto">
                                                <div class="avatar-sm p-1 py-2 h-auto bg-light rounded-3 shadow">
                                                    <div class="text-center">
                                                         <h5 class="mb-0 text-black">25</h5>
                                    ...
                                    <li class="list-group-item ps-0">
                                        <div class="row align-items-center g-3">
                                            <div class="col-auto">
                                                <div class="avatar-sm p-1 py-2 h-auto bg-light rounded-3 shadow">
                                                    <div class="text-center">
                                                        <h5 class="mb-0 text-black">20</h5>
                                    ...
                                    <li class="list-group-item ps-0">
                                        <div class="row align-items-center g-3">
                                            <div class="col-auto">
                                                <div class="avatar-sm p-1 py-2 h-auto bg-light rounded-3 shadow">
                                                    <div class="text-center">
                                                        <h5 class="mb-0 text-black">17</h5>
                                                        <div class="text-black">Wed</div>
                                                   </div>
                                                </div>
                                            </div>
                                    ...
                                    <li class="list-group-item ps-0">
                                        <div class="row align-items-center g-3">
                                            <div class="col-auto">
                                                <div class="avatar-sm p-1 py-2 h-auto bg-light rounded-3 shadow">
                                                    <div class="text-center">
                                                        <h5 class="mb-0 text-black">12</h5>
                                                        <div class="text-black">Tue</div>
                                                   </div>
                                                </div>
                                            </div>
