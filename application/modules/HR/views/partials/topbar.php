        ...
        <div class="navbar-header">
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    ...
                    <a href="/HR/<?php echo $this->session->userdata('system_id'); ?>" class="logo logo-dark">
                        
                        <span class="logo-lg mt-5">
                            <img src="/theme-assets/images/logo/BizAdminLogo_White.png" alt="" class="mt-3" height="30">
                        </span>
                    </a>

                    <a href="/HR/<?php echo $this->session->userdata('system_id'); ?>" class="logo logo-light">
                       
                        <span class="logo-lg mt-5">
                            <img src="/theme-assets/images/logo/BizAdminLogo_White.png"  class="mt-3" alt="" height="30">
                        </span>
                    </a>
                </div>
