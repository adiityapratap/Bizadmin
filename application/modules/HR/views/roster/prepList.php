 <div class="main-content">
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                  <div class="card-header">
                                    ...
                                    <h4 class="mb-sm-0 text-black ">Manage Prep Areas</h4>
                                                ...
                                                <table class="table align-middle table-nowrap" id="prepListDatatable">
                                                    <thead class="table-light">
                                                        <tr>
                                                            ...
                                                            <th class="sort" data-sort="prep_name">Color Code</th>
                                                     ...
                                                     <tbody class="list form-check-all" id="sortable">
                                                        ...
                                                        <tr id="row_<?php echo  $prep['id']; ?>" >
                                                            <td class="customer_name"><?php echo $prep['prep_name']; ?></td>
                                                             ...
                                                             <td class="color"><div class="<?php echo $prep['color']; ?> p-2 w-25"></div></td>
                                                    ...
                                                    <input class="form-check-input toggle-demo" type="checkbox" role="switch" id="<?php echo  $prep['id']; ?>" <?php if(isset($prep['status']) && $prep['status']  == '1'){ echo 'checked'; }?>>
                                                            ...
                                                            <td>
                                                             <div class="d-flex gap-2">
                                                                    <div class="edit">
                                                                        <a  onclick="showEditModal('<?php echo $prep['prep_name']; ?>',<?php echo $prep['site_id']; ?>,<?php echo $prep['id']; ?>,'<?php echo $prep['color']; ?>')" class="text-primary d-inline-block edit-item-btn">
      ...
      ?>
        ...
        <div id="flipModal" class="modal fade flip" tabindex="-1" aria-labelledby="flipModalLabel" aria-hidden="true" style="display: none;">
                                            ...
                                            <div class="modal-content border-0">
                                                ...
                                                <form class="tablelist-form prepAdd" autocomplete="off">
                                                        ...
                                                        <div class="row g-3">
                                                            <div class="col-lg-12">
                                                                <div class="text-center">
                                                                    ...
                                                                    <input type="text"  name="prep_name" id="input_prep_name" class="form-control" placeholder="Enter prep area name" required="">
    ...
    <select class="form-select" name="color" id="color">
        <option value="" selected> Select prep area color</option>
        <?php if(isset($colors) && !empty($colors)) { ?>
            <?php foreach($colors as $code => $name) { ?>
                <option value="<?php echo $code; ?>" class=".<?php echo $code; ?>"><?php echo $name; ?></option>
            <?php } ?>
        <?php } ?>
    </select>
</div>
        ...
        <div id="flipEditModal" class="modal fade flip"  role="dialog">
                                                        ...
                                                        <div class="row g-3">
                                                            <div class="col-lg-12">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <input type="text" id="edited_input_prep_name" name="prep_name" class="form-control" placeholder="Enter prep area name" required="">
                                                                <div class="invalid-feedback prepNameError" style="display:none">
                                                                    Please enter area name
                                                                    </div>
                                                                </div>
                                           ...
                                           <div class="col-md-12">
    <h6 class="fw-semibold">Select Color</h6>
    <select class="form-select" name="color" id="edited_color">
        <option value="" selected> Select prep area color</option>
        <?php if(isset($colors) && !empty($colors)) { ?>
            <?php foreach($colors as $code => $name) { ?>
                <option value="<?php echo $code; ?>" class=".<?php echo $code; ?>"><?php echo $name; ?></option>
     ...
     $(document).on("click", ".remove-item-btn" , function() {
      ...
      $('#prepListDatatable').DataTable({
        ...
        function showEditModal(prepName,site_id,prepId,colorClass){
       ...
       function addPrep(){
           ...
           let formData = $(".prepAdd").serialize();
            $.ajax({
                 type: "POST",
                 url: "/HR/prep/add",
                 data:formData,
        ...
        function updatePrep(){
            ...
            $.ajax({
                 type: "POST",
                 url: "Prep/updatePrep",
                 data:'prep_name='+prepName+'&id='+id+'&site_id='+siteId+'&color='+colorClass,
                 success: function(data){
                    location.reload();
                }
                });
