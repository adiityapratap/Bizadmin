<div class="main-content">
 <style>
 .timesheet-record td.child.ct-font-td {
    height: 39px;
}
 </style>
                 ...
                 <div class="card mt-4">
                     <div class="card-body">
                         <div class="d-flex w-100 justify-content-between">
                            <h5 class="card-title mb-3 text-black">Timesheet Details</h5>
                            <div>
                                                    ...
                                                    <div class="tab-pane fade show <?php if($icount == 1){ echo 'active'; } ?>" id="v-pills-<?php echo $icount; ?>" role="tabpanel" aria-labelledby="v-tab-<?php echo $icountTab; ?>">
                                                        ...
                                                        <div class="row g-4 align-items-center mx-0 mt-2 mb-2">
                                                            <?php if(($this->session->userdata('role')) == 'employee'){  ?> <!-- Heading for employee login -->
                                                                <div class="col-lg-12 col-12 mt-0"><h4 class="text-black text-center mb-0 fs-14 text-uppercase"><?php echo $employee_weekly_timesheet_detail[0]['employee_name']; ?></h4></div>
                                                                
                                                            <?php } else{ ?>     <!-- Heading for admin/manager login -->
                                                                <div class="col-lg-4 col-sm-6 col-md-4 mt-0">
                                                            ...
                                                            <div class="col-lg-1 col-sm-6 col-md-1 mt-0">
                                                                   ...
                                                                   <?php    for($count = 0;$count < 7;$count++ ) {  ?>
                                                                     ...
                                                                     <td class="child start_height date datetimepicker3"> <input class="editable_field form-control custom_disable" readonly="" type="text" data-provider="timepickr" data-time-basic="true" name="out_time@<?php echo $employee_weekly_timesheet_detail[$loop_count]['date']; ?>[]" value="<?php if($employee_weekly_timesheet_detail[$loop_count]['out_time'] !='') { echo date("H:i", strtotime($employee_weekly_timesheet_detail[$loop_count]['out_time']));} ?>"></td>
                                                                       ...
                                                                       <tr>
                                                                            ...
                                                                            <td class="child start_height"><input class="editable_field form-control custom_disable" readonly="" type="text" name="outletname@<?php echo $employee_weekly_timesheet_detail[$loop_count]['date']; ?>[]" value="<?php echo $employee_weekly_timesheet_detail[$loop_count]['outletname']; ?>"></td>
                                                                       </tr>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                <div class="card-header border-bottom-dashed">
                                                                    <h5 class="card-title text-black">Comments</h5>
                                                                </div>
                                                                                                    ...
                                                                                                    <div class="flex-grow-1 overflow-hidden">
                                                                                                        <div class="d-flex align-items-center">                            
                                                                                                            <div class="flex-shrink-0 chat-user-img online user-own-img align-self-center me-3 ms-0">
                                                                                                                ...
                                                                                                                <span class="ri-account-circle-fill fs-24 text-black"></span>
                                                                                                            </div>
                                                                                                            <div class="flex-grow-1 overflow-hidden">
                                                                                                                <h5 class="text-truncate mb-0 fs-16"><span class="text-black username text-uppercase"><?php echo $employee_weekly_timesheet_detail[0]['employee_name']; ?></span></h5>
                                                                                                    ...
                                                                                                    <div class="user-chat-content">
                                                                                                        <div class="ctext-wrap">
                                                                                                            <div class="ctext-wrap-content">
                                                                                                                <p class="mb-0 ctext-content text-black"><?php echo $comment['comments']; ?></p>
                                                                                                            </div>
                                                                                                           
                                                                                                        </div>
                                                                                                        <div class="conversation-name">
                                                                                                            <small class="text-black time"><?php if($comment['posted_by'] == 'employee'){ echo $comment['first_name'].' '.$comment['last_name']; }else{ echo $comment['username']; } ?> <?php echo date("d-m-Y", strtotime($comment['posted_at_date'])); ?> <?php echo date("H:i", strtotime($comment['posted_at_time'])); ?></small></div>
                                                                                                    </div>                
                                                                                                </div>            
                                                                                            </li>
                                                                                            <?php } else{ ?>
...
<script>
    function make_field_editable(obj){
        $(obj).parents(".tab-content").find(".editable_field").removeAttr("readonly");
        $(obj).parents(".tab-content").find(".editable_field").removeClass("custom_disable");
        $(obj).parents(".tab-content").find(".editable_field").css("border","1px solid #60e59f");
        $(obj).parents(".tab-content").find(".editable_field:first").focus();
        $(obj).parents(".tab-content").find(".saveBtn").css('display','inline-block');
