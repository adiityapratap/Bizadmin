        ...
        <div class="navbar-header">
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    ...
                    <a href="/Recipe/<?php echo $this->session->userdata('system_id'); ?>" class="logo logo-dark">
                    ...
                    <a href="/Recipe/<?php echo $this->session->userdata('system_id'); ?>" class="logo logo-light">
