...
class Site_model extends CI_Model{
	...
	function __construct() {
	   ...
	   public function add_site($data){
	    ...
	    return $this->tenantDb->insert('Compliance_sites',$data);
		}
	...
	$this->tenantDb->update('Compliance_sites');
    return true;
} 
...
return true;
		...
		public function get_all_sites($location_id='',$site_id=''){
         ...
         $where_conditions['id'] =  $site_id;
       	...
       	$sites = $this->tenantDb->select('*')
                     ...
                     ->get('Compliance_sites')->result_array();
        ...
        public function get_site_by_id($id){
	    	...
	    	$this->tenantDb->where('id' , $id);
	    return	$query = $this->tenantDb->get('Compliance_sites')->result_array;					 
