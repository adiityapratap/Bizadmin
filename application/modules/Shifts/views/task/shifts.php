 <div class="main-content">
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                  <div class="card-header">
                                    ...
                                    <h4 class="mb-sm-0 text-black ">Shift</h4>
    
                                    <div class="page-title-right">
                                        <div class="d-flex justify-content-sm-end">
                                         
                                            <div class="d-flex justify-content-sm-end">
                                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#flipModal"> <i class="ri-add-line fs-14 align-bottom me-1"></i>Add Shift </button>
                                            ...
                                            <div class="table-responsive table-card mb-1">
                                                <table class="table align-middle table-nowrap" id="prepListDatatable">
                                                    <thead class="table-light">
                                                        <tr>
                                                            <th class="sort" data-sort="prep_name">Shift Name</th>
                                                            <th class="sort" data-sort="status">Status</th>
                                                            <th class="no-sort" >Action</th>
                                                            </tr>
                                                    </thead>
                                                     <tbody class="list form-check-all" id="sortable">
                                                        <?php if(!empty($shiftLists)) {  ?>
                                                        <?php foreach($shiftLists as $shift){   ?>
                                                        <tr id="row_<?php echo  $shift['id']; ?>" >
                                                            <td class="customer_name"><?php echo $shift['name']; ?></td>
                                                            <td><div class="form-check form-switch form-switch-custom form-switch-success">
                                                    <input class="form-check-input toggle-demo" type="checkbox" role="switch" id="<?php echo  $shift['id']; ?>" <?php if(isset($shift['status']) && $shift['status']  == '1'){ echo 'checked'; }?>>
                                            ...
                                            <td>
                                                         ...
                                                         <ul class="list-inline hstack gap-2 mb-0">
                                                                ...
                                                                <li class="list-inline-item edit" data-bs-toggle="tooltip" data-bs-trigger="hover"
                                                                    ...
                                                                    <a onclick="showEditModal('<?php echo $shift['name']; ?>',<?php echo $shift['id']; ?>)"  class="text-primary d-inline-block edit-item-btn">
                                                ...
                                                <form class="tablelist-form" autocomplete="off">
                                                        ...
                                                        <div class="row g-3">
                                                            <div class="col-lg-12">
                                                                <div class="text-center">
                                                                    ...
                                                                    <label for="name-field" class="form-label">Shift Name</label>
                                                                    <input type="text"  name="input_prep_name" id="input_prep_name" class="form-control" placeholder="Enter prep Shift name" required="">
                                                    ...
                                                    <div class="modal-footer" style="display: block;">
                                                        <div class="hstack gap-2 justify-content-end">
                                                            ...
                                                            <button type="button" class="btn btn-green submitButtonSite" onclick="addShift()">Add </button>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
                                            ...
                                            <div class="modal-content border-0">
                                                ...
                                                <form class="tablelist-form" autocomplete="off">
                                                        ...
                                                        <div class="row g-3">
                                                            <div class="col-lg-12">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <input type="text" id="edited_input_prep_name" class="form-control" placeholder="Enter prep Shift name" required="">
                                                                <div class="invalid-feedback prepNameError" style="display:none">
                                                                    Please enter Shift name
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <div class="modal-footer" style="display: block;">
                                                        <div class="hstack gap-2 justify-content-end">
                                                            <button type="button" class="btn btn-light" data-bs-dismiss="modal">Close</button>
                                                            <button type="button" class="btn btn-green submitButtonSite" onclick="updateShift()">Save </button>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
     ...
     $(document).on("click", ".remove-item-btn" , function() {
      ...
      $('#prepListDatatable').DataTable({
        ...
        function addShift(){
            ...
            let shift_name = $("#input_prep_name").val();
    ...
    $("#sortable").sortable({
        ...
        update: function(event, ui) {
            ...
            $.ajax({
                url: "/Compliance/Prep/updateSortOrder",
                type: "POST",
