...
<div class="page-content">
               ...
               <div class="row g-4 mb-3">
                  <div class="col-sm-auto">
                   ...
                   <div class="d-flex justify-content-sm-end gap-2">
                       <!--<a href="#" onclick="history.back();" class="btn bg-orange waves-effect btn-label waves-light"><i class="ri-reply-fill label-icon align-middle fs-16 me-2"></i><span>Back</span></a>                                                -->
                          <?php if($configId == ''){ ?>
                       <button type="submit" class="btn btn-success btn-label waves-effect waves-light btnsave"><i class="ri-save-3-fill label-icon align-middle fs-16 me-2"></i>submit</button>
                     <?php }else { ?>
                     <button type="submit" class="btn btn-success btn-label waves-effect waves-light btnsave"><i class="ri-refresh-line label-icon align-middle fs-16 me-2"></i>Update</button>
                     <?php } ?>
                    </div>
                    </div>
                       </div>
                  ...
                  <div class="row mb-4"> 
                   ...
                   <div class="form-check form-switch form-switch-lg" dir="ltr">
                    ...
                    <div class="col-md-6 col-sm-12">
                   <div class="form-check form-switch form-switch-lg" dir="ltr">
                    <input type="checkbox" class="form-check-input" id="sendAttachInvoiceEmail" <?php echo (isset($configData['sendAttachInvoiceEmail']) && $configData['sendAttachInvoiceEmail'] == 1  ? 'checked' : '') ?> name="sendAttachInvoiceEmail">
                     <label class="form-check-label" for="sendAttachInvoiceEmail">Send email to suppliers for attaching invoice in the supplier portal</label>
                     </div>
                      </div>
                      </div>
                      <div class="row">  
      ...
      <input type="text" name="email" value="<?php echo (isset($configData['email']) && $configData['email'] !='' ? $configData['email'] : '') ?>" class="form-control">
                    <small>Add the email to display for supplier page </small> 
                      ...
                      <div class="col-md-4 col-sm-12">
                     <label for="sort_order" class="form-label fw-semibold">Reply to  Email</label>
      <input type="text" name="reply_to" value="<?php echo (isset($configData['reply_to']) && $configData['reply_to'] !='' ? $configData['reply_to'] : '') ?>" class="form-control">
                    <small>This email will be used as "reply to Email"  while sending orders to suppliers,supplier's reply will be recived on this Email  </small> 
                    </div> 
      ...
      $("#configForm").on("submit", function (e) {
        ...
        $.ajax({
           ...
           $(".btnsave").html('<i class="ri-save-3-fill label-icon align-middle fs-16 me-2"></i>Submit');
            },
