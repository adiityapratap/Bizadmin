...
<head>
    <meta charset="UTF-8">
    <title>New Order #<?php echo $orderId; ?></title>
</head>
    ...
    <table align="center" width="100%" cellpadding="0" cellspacing="0" style="border-collapse: collapse; background-color: #ffffff; margin: 20px auto; padding: 20px; box-shadow: 0px 0px 10px 0px rgba(0,0,0,0.2);">
        <tr>
            <td>
               ...
               <p style="font-size: 16px; line-height: 1.5; margin: 0 0 20px;">    
                To view the order information, please click the "View Order" button below. </p>
               
                 <p style="font-size: 16px; line-height: 1.5; margin: 0 0 20px;">    
                 Café Name/Location : <?php echo $orzName; ?> / <?php echo $locationName; ?> <br>
                 Café Email:          <?php echo $cafeEmail; ?> <br>
                 Café Contact Number: <?php echo $cafeContactNumber; ?> <br>
...
<span style="display:none;"><?php echo mt_rand(); ?></span>
