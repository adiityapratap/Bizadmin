<div class="main-content">
      ...
      <div class="row">
                        ...
                        <td class="supplier_name"><?php echo $row['supplier_name']; ?></td>
                         <td class="status">
    <?php if($row['status'] == 1){ $badgeClassName = 'bg-secondary-subtle text-secondary'; } if($row['status'] == 2){ $badgeClassName = 'bg-primary-subtle text-primary'; }  if($row['status'] == 3){ $badgeClassName = 'bg-success-subtle text-success'; }  if($row['status'] == 4){ $badgeClassName = 'bg-danger-subtle text-danger'; }  if($row['status'] == 5){ $badgeClassName = 'bg-danger-subtle text-danger'; } if($row['status'] == 7){ $badgeClassName = 'bg-success-subtle text-success'; } ?>
