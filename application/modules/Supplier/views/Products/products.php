                                            ...
                                            <table class="table table-bordered table-nowrap align-middle mb-0 diffOnAllDayDiv">
                                                ...
                                                <tbody>
                                                    <tr>
                                                       ...
                                                       <td><input type="text" required="required" class="form-control <?php echo$day  ?>_stockChkClass" name="<?php echo $day ?>_stockQty" value="<?php echo (isset($product_stockQty[$day.'_stockQty']) ? $product_stockQty[$day.'_stockQty'] : ''); ?>"></td>
                                                       <?php } ?>
                                                    </tr>
