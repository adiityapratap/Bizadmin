                                ...
                                <div class="card-body">
                                    <table id="reports-datatables" class="display table table-bordered" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            <?php 
                                            $percentageSpentByCategory = $filteredReport['weeklySpent'] > 0 && $filteredReport['weeklyBudget'] > 0 ? ($filteredReport['weeklySpent'] / $filteredReport['weeklyBudget']) * 100 : 0;
                                            ...
                                            <td></td>
                                            <td>Total</td>
                                             <?php  $totalWeeklyPercentage = $totalWeeklyBudget > 0 ? ($totalWeeklySpent / $totalWeeklyBudget) * 100  : 0; ?>
                                            ...
                                            <td><?php echo  number_format($totalWeeklyPercentage,2).'%'; ?></td>
