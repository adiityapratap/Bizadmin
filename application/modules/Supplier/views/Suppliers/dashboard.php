...
<div class="page-content">
                <div class="container-fluid">
                  <div class="row">
                            ...
                            <div class="col-xl-12">
                                <div class="card crm-widget">
                                    <div class="card-body p-0">
                                        <div class="row row-cols-xxl-4 row-cols-md-3 row-cols-1 g-1  <?php echo  (isset($configData['showDashboardHeaderSection']) && $configData['showDashboardHeaderSection'] == 0 ? 'd-none' : ''); ?>">
                                            ...
                                            <div class="col col-md-3 col-lg-3 col-sm-12 ">
                                             ...
                                             <div class="col col-md-3 col-lg-3 col-sm-12">
                                                <div class="mt-2 mt-lg-0 py-4 px-5">
                                                    ...
                                                    <h5 class="text-black text-uppercase fs-12">Order Sent  </h5>
                   ...
                   <!-- First Row: Today’s Orders and Internal Orders -->
<div class="row">
    <?php
    $showTodayOrderSection = isset($configData['showTodayOrderSection']) && $configData['showTodayOrderSection'] == 0 ? false : true;
    $showInternalOrder = isset($configData['showInternalOrder']) && $configData['showInternalOrder'] == 0 ? false : true;

    // Determine column classes for Today's Orders
    $todayOrderClass = 'col-xxl-6 col-lg-7 col-md-12 col-sm-12';
    if ($showTodayOrderSection && !$showInternalOrder) {
        $todayOrderClass = 'col-12'; // Full width if Internal Orders is hidden
    }

    // Determine column classes for Internal Orders
    $internalOrderClass = 'col-xxl-6 col-lg-5 col-md-12 col-sm-12';
    if ($showInternalOrder && !$showTodayOrderSection) {
        $internalOrderClass = 'col-12'; // Full width if Today's Orders is hidden
    }
    ?>

    <!-- Today’s Orders -->
    <div class="<?php echo $todayOrderClass; ?> <?php echo !$showTodayOrderSection ? 'd-none' : ''; ?>">
        <div class="card">
            ...
            <div class="card-body pb-0">
                <ul class="nav nav-pills card-header-pills mb-12 dashboardMandotryTabs" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" data-bs-toggle="tab" href="#mandatory" role="tab">Mandatory Orders</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" href="#allSuppliers" role="tab">All Orders</a>
                    </li>
                </ul>
                                        ...
                                        <div class="mx-n3 searchContainer">
                                            <ul class="list list-group list-group-flush mb-0 listOfItems">
                                                <?php if (!empty($mandatoryRecord)) foreach ($mandatoryRecord as $mandotrySupp) {
                                                    $mandatory_days = !empty($mandotrySupp['mandatory_days']) ? unserialize($mandotrySupp['mandatory_days']) : [];
                                                        ...
                                                        <li class="list-group-item <?php echo $weekday; ?>">
                                                            <div class="d-flex align-items-center pagi-list">
                                                                ...
                                                                <div class="flex-shrink-0 ms-2">
                                                                    ...
                                                                    <?php } elseif ($mandotrySupp['requireMST']) { ?>
                                                                        ...
                                                                        <?php } ?>
                                                                    <?php } elseif ($mandotrySupp['requireSC']) { ?>
                                                    ...
                                                    <li class="list-group-item <?php echo $weekday; ?>">
                                                        <div class="d-flex align-items-center pagi-list">
                                                            ...
                                                            <div class="flex-shrink-0 ms-2">
                                                                ...
                                                                <?php } elseif ($allSuppliers['requireMST']) { ?>
                                                                ...
                                                                <?php } elseif ($allSuppliers['requireSC']) { ?>
    ...
    <!-- Internal Orders -->
    <div class="<?php echo $internalOrderClass; ?> <?php echo !$showInternalOrder ? 'd-none' : ''; ?>">
        <div class="card">
...
<!-- Second Row: Deliveries and Internal Orders Delivery -->
<div class="row">
    <?php
    $showDeliverySection = isset($configData['showDeliverySection']) && $configData['showDeliverySection'] == 0 ? false : true;
    $showInternalOrderDeliverySection = isset($configData['showInternalOrderDeliverySection']) && $configData['showInternalOrderDeliverySection'] == 0 ? false : true;

    // Determine column classes for Deliveries
    $deliveryClass = 'col-xxl-6 col-lg-7 col-md-12 col-sm-12';
    if ($showDeliverySection && !$showInternalOrderDeliverySection) {
        $deliveryClass = 'col-12'; // Full width if Internal Orders Delivery is hidden
    }

    // Determine column classes for Internal Orders Delivery
    $internalDeliveryClass = 'col-xxl-6 col-lg-5 col-md-12 col-sm-12';
    if ($showInternalOrderDeliverySection && !$showDeliverySection) {
        $internalDeliveryClass = 'col-12'; // Full width if Deliveries is hidden
    }
    ?>

    <!-- Deliveries -->
    <div class="<?php echo $deliveryClass; ?> <?php echo !$showDeliverySection ? 'd-none' : ''; ?>">
        <div class="card">
            <div class="card-header align-items-center d-flex">
            ...
            <div class="card-body pb-0">
                <ul class="nav nav-pills card-header-pills mb-12 dashboardMandotryTabs" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" data-bs-toggle="tab" href="#todayDelivery" role="tab">Today’s Deliveries</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" href="#allDelivery" role="tab">All Deliveries</a>
                    </li>
                </ul>
                <div class="tab-content text-black">
                                ...
                                <tbody>
                                    <?php if (isset($todaysDelivery) && !empty($todaysDelivery)) { ?>
                                        <?php foreach ($todaysDelivery as $td) { ?>
                                            <tr>
                                                <td><a href="#" class="fw-medium link-primary">#<?php echo $td['id']; ?></a></td>
                                                <td><?php echo date('d-m-Y', strtotime($td['date_created'])); ?></td>
                                                <td><?php echo date('d-m-Y', strtotime($td['delivery_date'])); ?></td>
                                                <td><span class="text-black"><?php echo $td['supplier_name']; ?></span></td>
                                ...
                                <tbody>
                                    <?php if (isset($allDeliveries) && !empty($allDeliveries)) { ?>
                                        <?php foreach ($allDeliveries as $ad) { ?>
                                            <tr>
                                                <td><a href="#" class="fw-medium link-primary">#<?php echo $ad['id']; ?></a></td>
                                                <td><?php echo date('d-m-Y', strtotime($ad['date_created'])); ?></td>
                                                <td><?php echo date('d-m-Y', strtotime($ad['delivery_date'])); ?></td>
                                                <td><span class="text-black"><?php echo $ad['supplier_name']; ?></span></td>
                                                <td class="text-center">
    ...
    <!-- Internal Orders Delivery -->
    <?php if ($is_production) { ?>
        <div class="<?php echo $internalDeliveryClass; ?> <?php echo !$showInternalOrderDeliverySection ? 'd-none' : ''; ?>">
            <div class="card">
                <div class="card-header">
...
<!-- Third Row: Balance Overview and Focus Suppliers -->
<div class="row">
    <?php
    $showFooterGraphSection = isset($configData['showFooterGraphSection']) && $configData['showFooterGraphSection'] == 0 ? false : true;
    $showFocusSupplierSection = isset($configData['showFocusSupplierSection']) && $configData['showFocusSupplierSection'] == 0 ? false : true;

    // Determine column classes for Balance Overview
    $balanceOverviewClass = 'col-xxl-6 col-lg-7 col-md-12 col-sm-12';
    if ($showFooterGraphSection && !$showFocusSupplierSection) {
        $balanceOverviewClass = 'col-12'; // Full width if Focus Suppliers is hidden
    }

    // Determine column classes for Focus Suppliers
    $focusSupplierClass = 'col-xxl-6 col-lg-5 col-md-12 col-sm-12';
    if ($showFocusSupplierSection && !$showFooterGraphSection) {
        $focusSupplierClass = 'col-12'; // Full width if Balance Overview is hidden
    }
    ?>

    <!-- Balance Overview -->
    <div class="<?php echo $balanceOverviewClass; ?> <?php echo !$showFooterGraphSection ? 'd-none' : ''; ?>">
    ...
    <!-- Focus Suppliers -->
    <div class="<?php echo $focusSupplierClass; ?> <?php echo !$showFocusSupplierSection ? 'd-none' : ''; ?>">
        <div class="card h-100">
            <div class="card-header align-items-center d-flex">
                        ...
                        <tbody>
                            <?php if (isset($topFiveSuppliers) && !empty($topFiveSuppliers)) { ?>
                                <?php foreach ($topFiveSuppliers as $tf) { ?>
                                    <tr>
                                        <td><a href="#" class="fw-medium link-primary"><?php echo $tf['supplier_name']; ?></a></td>
                                        <td><span class="text-black"><?php echo '$' . number_format($tf['weeklyBudget'], 2, '.', ','); ?></span></td>
