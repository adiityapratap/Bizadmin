                                    ...
                                    <div class="card-body">
                                        <div id="customerList">
                                            <div class="row g-4 mb-3">
                                                ...
                                                <div class="col-sm">
                                                    <div class="d-flex justify-content-sm-end">
                                                        ...
                                                        <div class="d-flex justify-content-sm-end">
                                                            <a href="#" data-bs-toggle="modal" data-bs-target="#flipModal" class="btn btn-primary btn-label view-item-btn"><i class="ri-add-fill label-icon align-middle fs-16 me-2"></i><span>Add  UOM</span></a>
                                                        </div>
                                            ...
                                            <div class="table-responsive table-card mt-3 mb-1">
                                                <table class="table align-middle table-nowrap listDatatable" id="listDatatable">
