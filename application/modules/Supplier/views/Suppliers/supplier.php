                    ...
                    <div class="container-fluid">
                        ...
                        <a href="/Supplier/list/" class="btn bg-orange waves-effect btn-label waves-light "><i class="ri-reply-fill label-icon align-middle fs-16 me-2"></i><span>Back</span></a>                                
                                            ...
                                            <div class="row mt-4">
                                                ...
                                                <div class="col-lg-4 mb-4">
                                                    <div>
                                                        <label for="email" class="form-label">Supplier Email <span class="text-danger">*</span></label>
                                             ...
                                             $storageArea = [];
                                              ...
                                              ?> 
                                                 <div class="col-lg-5 areaList">
                                                  <label for="SupplierStatus" class="form-label">Storage Locations<span class="text-danger">*</span></label>
