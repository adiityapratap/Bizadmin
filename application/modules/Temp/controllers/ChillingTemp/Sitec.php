...
class Sitec extends MY_Controller
{
    ...
    {   
      	parent::__construct();
   	    $this->load->model('Chillingtemp/site_model');
   	...
   	public function index(){
            ...
            $this->load->view('ChillingTemp/site/siteList',$data);
...
// 		ini_set('display_errors', 1);
			if(isset($this->POST['site_name'])){
				...
				redirect('Temp/chillingTemp/site', 'refresh');
			}else{
			 $data['form_type'] ='add';   
			$this->load->view('general/header');
            $this->load->view('ChillingTemp/site/siteAdd',$data);
            $this->load->view('general/footer');
