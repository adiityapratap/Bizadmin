...
class Prepfood extends MY_Controller
{
    ...
    {   
        ...
        $this->load->model('Foodtemp/site_model');
...
// 			echo "<pre>"; print_r($data['prep_detail']); exit;
			$data['site_detail'] = $this->prep_model->get_allActive_sites(); 
			$this->load->view('general/header');
            $this->load->view('FoodTemp/prep/prepList',$data);
