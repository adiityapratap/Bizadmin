...
class Sitefood extends MY_Controller
{
    ...
    {   
   	...
   	public function index(){
            ...
            $this->load->view('FoodTemp/site/siteList',$data);
...
// 		ini_set('display_errors', 1);
			if(isset($this->POST['site_name'])){
				...
				redirect('Temp/foodTemp/site', 'refresh');
			}else{
			 $data['form_type'] ='add';   
			$this->load->view('general/header');
            $this->load->view('FoodTemp/site/siteAdd',$data);
            $this->load->view('general/footer');
