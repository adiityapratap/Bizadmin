<?php
class Sitec extends MY_Controller
{
    ...
    {   
   	...
   	public function index(){
            ...
            $this->load->view('SliceTemp/site/siteList',$data);
...
// 		ini_set('display_errors', 1);
			if(isset($this->POST['site_name'])){
				...
				// 		'emailToNotify' => $this->POST['emailToNotify'],
					...
					$this->common_model->commonRecordCreate('TEMP_slicingSites',$site_data);
				
				redirect('Temp/sliceTemp/site', 'refresh');
			}else{
			 $data['form_type'] ='add';   
			$this->load->view('general/header');
            $this->load->view('SliceTemp/site/siteAdd',$data);
            $this->load->view('general/footer');
...
// 		ini_set('display_errors', 1);
			...
			if(isset($this->POST['site_name'])){
				...
				// 		'emailToNotify' => $this->POST['emailToNotify'],
				 ...
				 $this->common_model->commonRecordUpdate('TEMP_slicingSites','id',$site_id, $site_data);
				redirect('Temp/sliceTemp/site', 'refresh');
			}else{
