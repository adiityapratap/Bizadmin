 <div class="main-content">
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                  <div class="card-header">
                                    ...
                                    <h4 class="mb-sm-0 text-black ">Chilling Prep Areas</h4>
     ...
     $(document).on("click", ".remove-item-btn" , function() {
                var id = $(this).attr('data-rel-id');
                    Swal.fire({
                      ...
                      if (e.value) {
                        $.ajax({
                            type: "POST",
                            url: "/Temp/ChillingTemp/Prepc/delete",
                            data:'id='+id,
      ...
      $('#prepListDatatable').DataTable({
        ...
        function addPrep(){
            ...
            $.ajax({
                 type: "POST",
                 url: "/Temp/ChillingTemp/Prepc/add",
        ...
        function updatePrep(){
            ...
            $.ajax({
                 type: "POST",
                 url: "/Temp/ChillingTemp/Prepc/updatePrep",
     ...
     if($(this).prop('checked')){
      ...
      enctype: 'multipart/form-data',
        url: "/Temp/ChillingTemp/Prepc/change_status",
    ...
    $("#sortable").sortable({
        ...
        update: function(event, ui) {
            ...
            $.ajax({
                url: "/Temp/ChillingTemp/Prepc/updateSortOrder",
                type: "POST",
