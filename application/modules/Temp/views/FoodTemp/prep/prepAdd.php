     ...
     <form class="row g-3 needs-validation" novalidate action="<?php echo base_url("prep/prepAdd") ?>" method="post">        
        ...
        <div id="infoMessage" class="mb-3"><?php  echo (isset($message) ? $message : '');?></div>
            ...
            <div class="row row-inner mb-2">
             ...
             <div class="row row-inner mb-2">
             <div class="col-md-7">
                  <label for="schedule_at" class="form-label fw-semibold">Temp Range *</label>
                             <div class="d-inline-flex gap-2 mb-3">
                         
                         <input type="number" class="form-control form-control-sm w-xs shadow-none" min="-20" max="40" step="1" id="input-select">
                         <input type="number" class="form-control form-control-sm w-xs shadow-none" min="-20" max="40" step="1" id="input-number">
                         </div>
                        <div id="html5"></div>
                        <small>Temperrature in Celcius degree</small>
                            </div><!-- end col -->
            </div>
        </div>
         </form>
