 <div class="main-content">
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                  <div class="card-header">
                                    ...
                                    <h4 class="mb-sm-0 text-black ">Food Temp Prep Areas</h4>
     ...
     $(document).on("click", ".remove-item-btn" , function() {
                var id = $(this).attr('data-rel-id');
                    Swal.fire({
                      ...
                      if (e.value) {
                        $.ajax({
                            type: "POST",
                            url: "/Temp/FoodTemp/Prepfood/delete",
                            data:'id='+id,
      ...
      $('#prepListDatatable').DataTable({
        ...
        function addPrep(){
            ...
            $.ajax({
                 type: "POST",
                 url: "/Temp/FoodTemp/Prepfood/add",
        ...
        function updatePrep(){
            ...
            $.ajax({
                 type: "POST",
                 url: "/Temp/FoodTemp/Prepfood/updatePrep",
     ...
     if($(this).prop('checked')){
      ...
      enctype: 'multipart/form-data',
        url: "/Temp/FoodTemp/Prepfood/change_status",
    ...
    $("#sortable").sortable({
        ...
        update: function(event, ui) {
            ...
            $.ajax({
                url: "/Temp/FoodTemp/Prepfood/updateSortOrder",
                type: "POST",
