                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <?php  if($form_type == 'add'){ ?>    
                                        <form action="/Temp/FoodTemp/Sitefood/add" method="POST">
                                             <?php }else if($form_type == 'edit'){ ?>
                                            <form action="/Temp/FoodTemp/Sitefood/edit/<?php echo (isset($site_detail[0]['id']) ? $site_detail[0]['id'] : ''); ?>" method="POST">     
                                              <?php } ?>
                                        <div id="customerList">
