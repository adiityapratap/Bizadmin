     ...
     let id = $(this).val();
       $.ajax({
        ...
        url: "<?= base_url('General/updateTableStatus') ?>",
         data:'id='+id+'&table_name=TEMP_fryertempProducts',
...
function editProduct(id) {
    $.get("<?= base_url('/Temp/FryerTemp/Fryerhome/getProductById/') ?>" + id, function(res) {
...
$('#productForm').on('submit', function(e) {
    ...
    $.ajax({
        url: "<?= base_url('/Temp/FryerTemp/Fryerhome/addOrUpdateProduct') ?>",
        type: "POST",
        data: $(this).serialize(),
        success: function(response) {
