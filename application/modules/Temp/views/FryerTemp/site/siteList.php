 <div class="main-content">
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                  <div class="card-header">
                                    ...
                                    <h4 class="mb-sm-0 text-black">Fryer Temp Manage Sites</h4>
    
                                    <div class="page-title-right">
                                        <div class="d-flex justify-content-sm-end">
                                         
                                            <div class="d-flex justify-content-sm-end">
                                                <a href="<?php echo  base_url('Temp/FryerTemp/Sitefry/add') ?>" class="btn btn-primary"> <i class="ri-add-line fs-14 align-bottom me-1"></i>Add Site</a>
                                                       ...
                                                       <input class="form-check-input toggle-demo" type="checkbox" role="switch" id="<?php echo  $site['id']; ?>" <?php if(isset($site['status']) && $site['status']  == '1'){ echo 'checked'; }?>>
                                                            ...
                                                            <td>
                                                             <div class="d-flex gap-2">
                                                                    <div class="edit">
                                                                        <a  href="<?php echo base_url('Temp/FryerTemp/Sitefry/edit/'.$site['id']); ?>" class="text-primary d-inline-block edit-item-btn">
                ...
                var id = $(this).attr('data-rel-id');
                    Swal.fire({
                      ...
                      if (e.value) {
                        $.ajax({
                            type: "POST",
                            url: "/Temp/FryerTemp/Sitefry/delete",
                            data:'id='+id,
     ...
     if($(this).prop('checked')){
      ...
      enctype: 'multipart/form-data',
        url: "/Temp/FryerTemp/Sitefry/change_status",
