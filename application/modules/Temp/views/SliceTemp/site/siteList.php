 <div class="main-content">
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                  <div class="card-header">
                                    ...
                                    <h4 class="mb-sm-0 text-black">Slicing Manage Sites</h4>
    
                                    <div class="page-title-right">
                                        <div class="d-flex justify-content-sm-end">
                                         
                                            <div class="d-flex justify-content-sm-end">
                                                <a href="<?php echo  base_url('Temp/SliceTemp/Sitec/add') ?>" class="btn btn-primary"> <i class="ri-add-line fs-14 align-bottom me-1"></i>Add Site</a>
                                            ...
                                            <div class="table-responsive table-card mb-1">
                                                ...
                                                <td>
                                                             <div class="d-flex gap-2">
                                                                    <div class="edit">
                                                                        <a  href="<?php echo base_url('Temp/SliceTemp/Sitec/edit/'.$site['id']); ?>" class="text-primary d-inline-block edit-item-btn">
                ...
                var id = $(this).attr('data-rel-id');
                    Swal.fire({
                      ...
                      if (e.value) {
                        $.ajax({
                            type: "POST",
                            url: "/Temp/SliceTemp/Sitec/delete",
                            data:'id='+id,
     ...
     if($(this).prop('checked')){
      ...
      enctype: 'multipart/form-data',
        url: "/Temp/SliceTemp/Sitec/change_status",
