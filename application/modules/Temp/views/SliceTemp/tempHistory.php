                        ...
                        <div class="col-12 tempDiv">
                            <div class="card">
                              <div class="card-header align-items-center d-flex">
                               <h4 class="card-title mb-0 flex-grow-1 text-faded">Slicing Temperature History</h4>   
                                  
                                   </div>  
                                
                                 <div class="card-body">
                                     <form action="<?php echo base_url('/Temp/home/slicinghistoryData') ?>" method="post">
                      ...
                      <small>Select from and to date to view the history, Please select date  in weekly range i.e 1st to 7th</small>
                       ...
                       <select class="form-select siteDropdown" name="site_id">
                                             <option> Select Site</option>
                                                ...
                                                <option <?php echo $selected; ?> class="dropdown-item" value="<?php echo $sites['id'] ?>"><?php echo $sites['site_name'] ?></option>
                                                <?php $count++; } } ?>
                                       </select>
                                       </div>  
