                        ...
                        <div class="col-12 tempDiv">
                            <div class="card">
                              <div class="card-header align-items-center d-flex">
                               <h4 class="card-title mb-0 flex-grow-1 text-faded">Equipment Temperature History</h4>   
                                  
                                   </div>  
                                
                                 <div class="card-body">
                                     <form action="<?php echo base_url('/Temp/home/historyData') ?>" method="post">
                      ...
                      <small>Select from and to date to view the history, Please select date  in weekly range i.e 1st to 7th</small>
                       ...
                       <select class="form-select siteDropdown" name="site_id">
                                             <option value=''> All Site</option>
                                                <?php if(!empty($site_detail)) { $count =0; foreach($site_detail as $sites) {  ?>
                                                <option  class="dropdown-item" href="#" value="<?php echo $sites['id'] ?>"><?php echo $sites['site_name'] ?></option>
                                                <?php $count++; } } ?>
                                       </select>
                                       </div>  
