                            ...
                            <div class="card py-3" id="orderList">
                                <div class="card-header  border-0 ">
                                    <div class="d-flex align-items-center gap-2">
                                        <h5 class="card-title mb-0 flex-grow-1 text-black">Equipment</h5>
                                       <a type="button" class="btn btn-primary btn-sm fs-14" 
                                                id="create-btn" href="<?php echo base_url('Temp/equip') ?>"><i
                                                    class="ri-add-line align-bottom "></i> Add Equipment
                                                </a>
                                            ...
                                            <table class="table table-nowrap align-middle" id="activeEquip">
                                                ...
                                                <thead class="text-muted table-light">
                                                    <tr class="text-uppercase">
                                                        ...
                                                        <th class="sort" data-sort="customer_name">Equipment Name</th>
                                                         ...
                                                         <th class="sort" data-sort="product_name">Temp. Range</th>
                                                ...
                                                <tbody class="list form-check-all" id="sortable">
                                                    ...
                                                    <?php if(!empty($EquipList)) {   ?>
                                                     <?php foreach($EquipList as $Equip) {  ?>
                                                    <tr id="<?php echo 'row_'.$Equip->id;  ?>">
                                                        <th scope="row">
                                                            <div class="form-check">
                                                                <input class="form-check-input checkAll checkbox-item" type="checkbox" name="checkAll" value="<?php echo $Equip->id;  ?>">
                                                            </div>
                                                        </th>
                                                       
                                                        <td class="descr text-wrap handle"><?php echo (isset($Equip->equip_name) ? $Equip->equip_name : '');  ?></td>
                                                          <td class="descr text-wrap handle"><?php echo (isset($Equip->prep_name) ? $Equip->prep_name : '');  ?></td>
                                                        <td class="descr text-wrap handle"><?php echo (isset($Equip->site_name) ? $Equip->site_name : '');  ?></td>
                                                        <td class="descr text-wrap handle"><?php echo (isset($Equip->temp_min) ? $Equip->temp_min : '');  ?> to <?php echo (isset($Equip->temp_max) ? $Equip->temp_max : '');  ?></td>
                                                     
                                                        <td class="descr text-wrap handle"><?php echo (isset(TEMPSCHEDULE[$Equip->schedule_at]) ? TEMPSCHEDULE[$Equip->schedule_at] : '');  ?></td>
                                                       <td class="descr text-wrap handle"><?php echo (isset($Equip->equip_time) ? $Equip->equip_time : '');  ?></td>
                                                       
                                                       <td>
                                                       <div class="form-check form-switch form-switch-custom form-switch-success">
                                                        <input class="form-check-input checklisttoggle-demo" type="checkbox" role="switch" data-tablename="TEMP_eqipment" data-id="<?php echo  $Equip->id; ?>" <?php echo ($Equip->status ? 'checked' : '');  ?>>
                                                       </div>
                                                       </td>
                                                        ...
                                                        <td>
                                                            <ul class="list-inline hstack gap-2 mb-0">
                                                                ...
                                                                <li class="list-inline-item edit" data-bs-toggle="tooltip" data-bs-trigger="hover"
                                                                    ...
                                                                    <a href="<?php echo base_url('Temp/Equip/edit/'.$Equip->id) ?>"  class="text-primary d-inline-block edit-item-btn">
                                                                ...
                                                                <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover"
                                                                    ...
                                                                    <a class="text-danger d-inline-block remove-item-btn" data-bs-toggle="modal"
                                                                        onclick="deleteThisChecklist(this,<?php echo  $Equip->id; ?>)">
...
function deleteMultipleCheckl(){
   ...
   $('.checkbox-item:checked').each(function() {
      ...
      if (selectedValues.length > 0) {
            $.ajax({
                url: '/Temp/equip/deleteMultiple',
                type: 'POST',
                data: { 
                    table_name: 'TEMP_eqipment', 
 ...
 $(document).on("click", "#delete-record" , function() {
     let id = $(this).val();
       $.ajax({
         ...
         data:'id='+id+'&table_name=TEMP_eqipment',
