<?php if($form_type == 'view'){ $disabled = 'disabled'; }else{ $disabled = ''; } ?>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <?php  if($form_type == 'add'){ ?>    
                                        <form action="/Temp/Site/add" method="POST">
                                             <?php }else if($form_type == 'edit'){ ?>
                                            <form action="/Temp/Site/edit/<?php echo (isset($site_detail[0]['id']) ? $site_detail[0]['id'] : ''); ?>" method="POST">     
                                              <?php } ?>
                                        <div id="customerList">
                                    ...
                                    <a href="/Temp/site" class="btn bg-orange waves-effect btn-label waves-light"><i class="ri-reply-fill label-icon align-middle fs-16 me-2"></i><span>Back</span></a>
                                                        <?php  if($form_type == 'add'){ ?>
        ...
        <small>Add the predetermined action items to be available if the temperature/calibration exceeds the range</small> 
                 </div>
                 </div>
