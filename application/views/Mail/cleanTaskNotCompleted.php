        ...
        <tr>
            <td>
                ...
                <p style="font-size: 16px; line-height: 1.5; margin: 0 0 20px;">
                    Hi,<br><br>
                    The following cleaning task are not completed for location  :<?php echo $locationName; ?>
                </p>
                ...
                <?php // $locationName = fetchLocationNamesFromIds($taskList->location_id,true); ?>
                    <!-- <tr>-->
                    ...
                    <tr>
                        ...
                        <td style="border: 1px solid #000; padding: 5px;"><?php echo $taskList->task_name; ?></td>

                        <td style="border: 1px solid #000; padding: 5px;"><?php echo $taskList->prep_name; ?></td>
                    ...
                    <!--</tr>-->
                        ...
                        <td style="border: 1px solid #000; padding: 5px;"><?php echo $taskList->task_time; ?></td>
                    </tr>
                    <?php }  ?>
                    </tbody>
                </table>
