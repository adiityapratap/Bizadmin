...
<head>
    <meta charset="UTF-8">
    <title>Incompleted Checklist</title>
</head>
        ...
        <tr>
            <td>
                ...
                <p style="font-size: 16px; line-height: 1.5; margin: 0 0 20px;">
                    Hi,<br><br>
                    The following tasks are not completed in the location : <?php echo $locationName; ?>
                </p>
                ...
                <table style="width: 60%; border: 1px solid #000; border-collapse: collapse;">
                     <thead style="background-color: #172154; color: #fff;">
                        <td style="border: 1px solid #000; padding: 5px;">Task Name</td>
                        <td style="border: 1px solid #000; padding: 5px;">Time</td>
                         <td style="border: 1px solid #000; padding: 5px;">Comments</td>
                    </thead>
                    <tbody>
                     <?php foreach($LocationWiseDataOfChecklists as $LocationWiseDataOfChecklist) {  ?>
                <?php // $locationName = fetchLocationNamesFromIds($equipList->location_id,true); ?>
                    ...
                    <tr>
                        ...
                        <td style="border: 1px solid #000; padding: 5px;"><?php echo $LocationWiseDataOfChecklist->title; ?></td>
                        <td style="border: 1px solid #000; padding: 5px;"><?php echo $LocationWiseDataOfChecklist->deadline_time; ?></td>
                        <td style="border: 1px solid #000; padding: 5px;"><?php echo $LocationWiseDataOfChecklist->checklistComments; ?></td>
                    </tr>
                    <?php }  ?>
                    </tbody>
                </table>
