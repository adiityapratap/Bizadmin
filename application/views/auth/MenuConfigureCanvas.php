...
<div class="col-lg-12 menuAccess mb-3 menuDiv">                                          
                                                ...
                                                <div class="offcanvas-foorter border p-3 text-center">
                                                    <small class="color-black">NOTE :  Please save menu for one system at a time</small>
                                                    <button type="button" id="saveMenuForThisUser" class="btn btn-lg btn-success btn-label waves-effect waves-light">
                                                        <i class="ri-save-3-line label-icon align-middle fs-16 me-2"></i> Save Menu</button>
                                                </div>
                                            </div>
