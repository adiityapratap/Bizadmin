   <link rel="stylesheet" href="<?php echo base_url(""); ?>theme-assets/libs/glightbox/css/glightbox.min.css">
    ...
    <link href="<?= base_url('theme-assets/css/bootstrap.min.css'); ?>?v=<?= filemtime(FCPATH . 'theme-assets/css/bootstrap.min.css') ?>" rel="stylesheet" type="text/css" />
    ...
    <!--<link href="<?php echo base_url(""); ?>theme-assets/css/custom.min.css?v=<?= filemtime('style.css') ?>" rel="stylesheet" type="text/css" />-->
    <link href="<?= base_url('theme-assets/css/custom.min.css'); ?>?v=<?= filemtime(FCPATH . 'theme-assets/css/custom.min.css') ?>" rel="stylesheet" type="text/css" />

    <link href="<?= base_url('theme-assets/css/style.css'); ?>?v=<?= filemtime(FCPATH . 'theme-assets/css/style.css') ?>" rel="stylesheet" type="text/css" />
    ...
    <!--For Cash Site , check later if we can reuse-->
   <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js"></script>
    ...
    <script src="<?= base_url('login-assets/js/custom.js'); ?>?v=<?= filemtime(FCPATH . 'login-assets/js/custom.js') ?>"></script>
