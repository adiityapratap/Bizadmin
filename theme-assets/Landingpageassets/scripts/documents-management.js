  ...
  const features = [
    {
      ...
      image:
        "https://bizadmin.com.au/theme-assets/Landingpageassets/assets/documents/feature.jpg",
      benefits: [
        "Organized Structure: Keep your documents structured and accessible with a well-organized folder system.",
        "Customizable Categories: Create a personalized document management system that fits your workflow.",
      ],
    },
    {
      id: "upload-documents",
      ...
      image:
        "https://bizadmin.com.au/theme-assets/Landingpageassets/assets/documents/feature.jpg",
      benefits: [
        "Effortless Upload: Quickly and securely upload important files without hassle.",
        "Version Control: Keep track of edits and revisions to maintain document integrity.",
      ],
    },
    {
      id: "share-documents",
      ...
      image:
        "https://bizadmin.com.au/theme-assets/Landingpageassets/assets/documents/feature.jpg",
      benefits: [
        "Secure Sharing: Ensure sensitive information is shared only with authorized personnel.",
        "Access Permissions: Maintain data security with precise control over document access.",
      ],
    },
    {
      id: "customize-access-control",
      ...
      image:
        "https://bizadmin.com.au/theme-assets/Landingpageassets/assets/documents/feature.jpg",
      benefits: [
        "Granular Permissions: Ensure proper security by granting appropriate access to team members.",
        "Role-based Access: Protect confidential documents with structured role-based permissions.",
      ],
    },
    {
      id: "staff-training-documents",
      ...
      image:
        "https://bizadmin.com.au/theme-assets/Landingpageassets/assets/documents/feature.jpg",
      benefits: [
        "Central Repository: Ensure training materials are always accessible and up-to-date.",
        "Easy Access: Empower employees with readily available learning resources.",
      ],
    },
  ];
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const selectedProduct =
    products.find(
      (product) =>
        product.name.toLowerCase() === "Document Manage".toLowerCase()
    ) ?? products[0];
