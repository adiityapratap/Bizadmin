document.addEventListener("DOMContentLoaded", function () {
  const features = [
    {
      id: "Daily Temperature Recording",
      title: "Daily Temperature Recording",
      description: "Plan ahead by scheduling ",
      image:
        "https://bizadmin.com.au/theme-assets/Landingpageassets/assets/temperature/daily-temperature-recording.jpg",
      benefits: [
    ...
    },
    {
      ...
      description: "Plan ahead by scheduling ",
      image:
        "https://bizadmin.com.au/theme-assets/Landingpageassets/assets/temperature/notifications.jpg",
      benefits: [
    ...
    {
      id: "Historical Data Storage",
      title: "Historical Data Storage",
      description: "Plan ahead by scheduling ",
      image:
        "https://bizadmin.com.au/theme-assets/Landingpageassets/assets/temperature/historical-data.jpg",
      benefits: [
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const selectedProduct =
    products.find(
      (product) =>
        product.name.toLowerCase() === "Temperature Recording".toLowerCase()
    ) ?? products[0];
